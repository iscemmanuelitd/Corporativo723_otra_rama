    ...
    let $fs2 = $("<fielset>").addClass("_datPerso").html("<h3>Dirección</h3><br>")
    ...
    .append(_inp("tel","tel","enlinea w100","999-9999999",true)).append(_inp("text","cveElector","enlinea w150","Clave de Elector",true)).append(_div("fileuploader","subirCredencial enlinea","Arrastre  y suelte la imagen de la credencial"))
